...
from jira_cleanup.src.domain.entities.action import ActionRecommendation, ActionType
from jira_cleanup.src.domain.repositories.comment_repository import CommentRepository


logger = logging.getLogger('jira_cleanup.infrastructure.repositories.jira_comment_repository')
